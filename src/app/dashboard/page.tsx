  ...
  return (
    <AppShell>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-10">
        ...
        <div className="mb-8 rounded-xl border border-white/10 bg-white/5 p-6 flex items-center gap-5">
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <span
                className={`inline-flex items-center rounded-full border px-2 py-0.5 text-xs font-semibold capitalize ${ROLE_BADGE[role]}`}
              >
                {role}
              </span>
            </div>
        ...
        {/* Admin: analytics + user management table */}
        {isAdmin && (
          <div>
                    ...
                    {users.map((user) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          <span
                            className={`inline-flex items-center rounded-full border px-2 py-0.5 text-xs font-semibold capitalize ${ROLE_BADGE[user.role] ?? ROLE_BADGE.rider}`}
                          >
                            {user.role}
                          </span>
                        </td>
